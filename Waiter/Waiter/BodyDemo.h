...
private:
	...
	ID2D1SolidColorBrush*   m_pBrushLightBlue;

	TuxPts  tuxedo;
	bool m_pTudexoLoaded;
	...
	///<summary>
	/// draw the tuxedo using joints
	///
	///</summary>
	void DrawTux(const Joint* pJoints, const D2D1_POINT_2F* pJointPoints);


	bool  AllPointsTracked(const Joint* pJoints);
